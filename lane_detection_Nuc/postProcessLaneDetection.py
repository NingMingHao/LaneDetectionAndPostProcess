...
from lane_detection_msgs.msg import CNNLaneDetectionMsg, LaneDetectionMsg
...
if __name__ == "__main__":    
    ...
    lane_detection_pub = rospy.Publisher("/Lane_Detection_Result", LaneDetectionMsg, queue_size=10)
